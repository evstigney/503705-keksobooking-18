...
window.map = (function () {
  ...
  /**
   * Описание функции отрисовки пинов на основе моковых данных
   *
  ...
  /**
   * Отрисовывем карточку в зависимости от кликнутого пина,
  ...
  /**
   * Итоговая отрисовка пинов на странице на основе моки,
